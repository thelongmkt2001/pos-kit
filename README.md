...
lại **21 lần tính tới 2026-09-17**, trong đó có những lần xảy ra **ngay trong lúc đang viết về nó**,
...
| **Việc tiếp theo còn đúng giai đoạn** | Mục *việc tiếp theo* của `STATE.md` không có dòng `VIEC:` đã trả lời; hoặc **không còn gọi tên** giai đoạn đang làm — phần nhìn về phía trước đã chết mà vẫn đọc lên như một kế hoạch | Những việc kể trong đó **đang** làm, hay đủ, hay xếp đúng thứ tự |
...
| **Sổ nợ không tự già đi trong im lặng** | Một món nợ **đang mở** không ghi *soi lần cuối* và *hạn soi lại*, hoặc đã **quá hạn** — dòng nợ đọc lên như hiện trạng trong khi món đó có thể đã xong từ lâu | Món đó **còn thật** hay đã được sửa. Máy đếm ngày, nó không đọc được ý nghĩa |
